<template>
  <div>
    <main class="page">
      ...
      <div :class="`theme-weiyie-wrapper ${bgStyle}`">
        <ArticleInfo v-if="isArticle()" />
        <component
          class="theme-weiyie-content"
          v-if="pageComponent"
          :is="pageComponent"
        />
        ...
        <div class="content-wrapper">
          ...
          <Content class="theme-weiyie-content" />
        </div>
...
export default {
  ...
  props: ['sidebarItems'],
  components: { PageEdit, PageNav, ArticleInfo, Catalogue, UpdateArticle },
  created () {
...
.page
  ...
  >*
    @extend $weiyie-wrapper
.theme-weiyie-wrapper
  .content-wrapper
    position relative
  h1 img
